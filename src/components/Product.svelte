...
<SectionWrapper id="product">
	...
	>
		<div class="flex flex-col gap-2">
			...
			<h3 class="text-4xl sm:text-5xl md:text-6xl max-w-[1000px] mx-auto w-full font-semibold">
		...
		{#each productFeatures as productFeature, index}
			<ProductCard {productFeature} {index}>
				{#if index === 0}
					Experience a begginer exercise <span class="text-indigo-400 font-medium"> master </span> class
				{:else if index === 1}
					Lay foundations for <span class="text-indigo-400 font-medium">routine</span> and
					Consistency
				{:else}
					Workouts specific to your <span class="text-indigo-400 font-medium">environment</span> and
